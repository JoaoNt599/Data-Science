Este arquivo descreve todos os materiais e conteúdos para o curso de "Fundamentos Básicos de R" da Beta Analítica, ministrado por Huriel Ruan Reichel.
...
dados usados no curso :
     ...
     CPI2015.xslx - Dados sobre percepção da corrupção.

     hydrantes.csv - dados sobre a localização de hidrantes em Zurich, Suíça.

     nypd.csv - Dados de crime, apenas explorados nos exercícios.

     olympics.txt - Dados da Olimpíada de Tóquio.
